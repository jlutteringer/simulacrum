...
external fun getFloatsFromUintRGB(rgb: Number): Number = definedExternally
external fun getComponentCount(attributes: Number, glContext: WebGLRenderingContext): Number = definedExternally
